/******/ (function (modules) {
  ...
  \*********************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _scripts_checking_account__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./scripts/checking-account */ "./src/scripts/checking-account.ts"
        );
        /* harmony import */ var _scripts_renderer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./scripts/renderer */ "./src/scripts/renderer.ts"
        );
        /* harmony import */ var _scripts_savings_account__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./scripts/savings-account */ "./src/scripts/savings-account.ts"
        );
        /* harmony import */ var _scripts_enums__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./scripts/enums */ "./src/scripts/enums.ts"
        );
        /* harmony import */ var _scripts_account_list__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./scripts/account-list */ "./src/scripts/account-list.ts"
        );
        ...
        var Main = /** @class */ (function () {
          function Main(renderer) {
            ...
            this.checkingAccount = new _scripts_checking_account__WEBPACK_IMPORTED_MODULE_0__[
              "CheckingAccount"
            ]({
              id: 1,
            ...
            this.savingsAccount = new _scripts_savings_account__WEBPACK_IMPORTED_MODULE_2__[
              "SavingsAccount"
            ]({
              id: 100,
            ...
            this.renderer.render(
              "<h2>Welcome to Acme Bank!</h2><br /><h5>Your Accounts:</h5><br />" +
                html
            );
          }
          Main.prototype.renderAccounts = function () {
            var acctsHtml = "";
            var accList = new _scripts_account_list__WEBPACK_IMPORTED_MODULE_4__[
              "AccountList"
            ]();
          ...
          Main.prototype.renderAccount = function (account) {
            var accountType =
              _scripts_enums__WEBPACK_IMPORTED_MODULE_3__["AccountType"][
                account.accountType
              ];
            var html =
              "\n                <h3>" +
        ...
        var renderer = new _scripts_renderer__WEBPACK_IMPORTED_MODULE_1__[
          "Renderer"
        ](document.querySelector("#viewTemplate"));
    ...
    /***/ "./src/scripts/checking-account.ts":
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _bank_account__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./bank-account */ "./src/scripts/bank-account.ts"
        );
        /* harmony import */ var _enums__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./enums */ "./src/scripts/enums.ts"
        );
        var __extends =
        ...
        var CheckingAccount = /** @class */ (function (_super) {
          ...
          function CheckingAccount() {
            ...
            _this.accountType =
              _enums__WEBPACK_IMPORTED_MODULE_1__["AccountType"].Checking;
            return _this;
          }
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        var SavingsAccount = /** @class */ (function (_super) {
          ...
          function SavingsAccount(accountSettings) {
            ...
            _this.accountType =
              _enums__WEBPACK_IMPORTED_MODULE_1__["AccountType"].Savings;
          ...
          SavingsAccount.prototype.addInterest = function () {
            this.balance =
              this.balance + this.balance * (this._interestRate / 100);
          };
          return SavingsAccount;
        })(_bank_account__WEBPACK_IMPORTED_MODULE_0__["BankAccount"]);
